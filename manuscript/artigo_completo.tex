...
(API do Semantic Scholar e Topic Modeling via LDA), um corpus consolidado de 100 artigos.
Os resultados elucidam uma profunda dissonância empírica: \textbf{37,5\% dos estudos empíricos}
...
de 40 estudos empíricos revisados entre 2020 e 2026,
\textbf{37,5\% reportaram achados negativos} e \textbf{57,5\% reportaram efeitos mistos ou neutros} --- a introdução de
...
A aplicação do protocolo PRISMA (Figura~\ref{fig:prisma}) permitiu a consolidação do corpus de pesquisa.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.90\textwidth]{results/figures/fig2_prisma_flow.png}
  \caption{Fluxo PRISMA}
  \label{fig:prisma}
\end{figure}
...
Os achados empíricos (Figura~\ref{fig:donut}) demonstram uma tendência crítica na literatura.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.68\textwidth]{results/figures/fig1_empirical_findings.png}
  \caption{Gráfico de Achados}
  \label{fig:donut}
\end{figure}

A síntese da pesquisa é apresentada no mapa conceitual (Figura~\ref{fig:axes}).

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{results/figures/fig3_dialectical_axes.png}
  \caption{Eixos Dialéticos}
  \label{fig:axes}
\end{figure}
